...
//                        Intent RiderIntent = new Intent(Rider_page.this, RiderMapsActivity.class);
                        Intent RiderIntent = new Intent(Rider_page.this, CustomersMapActivity.class);
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful())
                    {
                        ...
                        RiderDatabaseRef = FirebaseDatabase.getInstance().getReference().child("Users").child("Riders").child(onlineRiderID);

                        RiderDatabaseRef.setValue(true);
//                        Intent driverIntent = new Intent(Rider_page.this, RiderMapsActivity.class);
                        Intent driverIntent = new Intent(Rider_page.this, CustomersMapActivity.class);
